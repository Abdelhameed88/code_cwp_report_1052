...
class DualEncMultiDcoInvNetWithTailoredDecoders(nn.Module):
    ...
    def __init__(self, lstm_hidden_size=512, lstm_layers=2, **kwargs):
        ...
        self.decoders = nn.ModuleList([
            Decoder(in_fea=self.encoder_with_lstm.lstm_hidden_size, out_fea=1, final_output_size=8, **kwargs),
            Decoder(in_fea=self.encoder_with_lstm.lstm_hidden_size, out_fea=1, final_output_size=16, **kwargs),
            Decoder(in_fea=self.encoder_with_lstm.lstm_hidden_size, out_fea=1, final_output_size=32, **kwargs),
            Decoder(in_fea=self.encoder_with_lstm.lstm_hidden_size, out_fea=1, final_output_size=64, **kwargs),
        ])
